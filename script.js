    ...
    fetch(Api)
        ...
        .then(data => {
            ...
            data.products.forEach(item => {
                carts.innerHTML += `
                            <div
                            class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col overflow-hidden">
                            ...
                            <div class="p-5 flex flex-col flex-grow">
                                ...
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <span class="text-xs font-semibold text-red-500 bg-red-50 px-2 py-1 rounded">-${item.discountPercentage}% OFF</span>
                                </div>
